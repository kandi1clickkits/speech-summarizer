...
ECHO======================================================================================
SET KIT_NAME=speech-summarizer
...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/speech-summarizer/releases/download/v1.0.0/speech-summarizer.zip
SET REPO_DEPENDENCIES_URL=https://raw.githubusercontent.com/kandi1clickkits/speech-summarizer/main/requirements.txt
SET REPO_NAME=speech-summarizer.zip
SET EXTRACTED_REPO_DIR=speech-summarizer
...
SET VIRTUALENV_NAME=speech-summarizer-env
...
IF /I "%CONFIRM%" NEQ "Y" (
	...
	python -m jupyter notebook "%EXTRACTED_REPO_DIR%\%NOTEBOOK_NAME2%" >> !WORKING_DIR!\log.txt 2>&1
)
PAUSE
EXIT /B %ERRORLEVEL%
